        ...
        <div className="notice-container">
          ...
          <div className="notice-grid">
            {loading ? (
              // 로딩 중 스켈레톤 UI 느낌의 표시
              [1, 2, 3].map((n) => (
                <div key={n} className="notice-card" style={{ opacity: 0.5, backgroundColor: '#f9f9f9' }}> {/* 카드 배경색 변경 */}
